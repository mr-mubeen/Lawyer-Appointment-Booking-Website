...
$check = "SELECT * FROM appointments join lawyer , clients where clients.ClientID = appointments.client_id  and lawyer.LawyerID = appointments.lawyer_id";
    ...
    <table style="text-align:center;  font-size:20px; border: 2px solid black;" class="">
       ...
       while($row = mysqli_fetch_assoc($result1)){ ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['appoint_service']; ?></td>
